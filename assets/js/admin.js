$(function(){
    ...
    $('#server_updateTrackandGroup').click(function(e){
        e.preventDefault();
        io.socket.get("/upd", null, function (data, jwres){
    ...
    $('#server_updateCars').click(function(e){
        e.preventDefault();
        io.socket.get("/updCars", null, function (data, jwres){
